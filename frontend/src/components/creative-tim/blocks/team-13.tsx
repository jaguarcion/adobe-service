      ...
      <div className="container mx-auto grid grid-cols-1 gap-y-12 md:gap-x-16 lg:grid-cols-12">
        <div className="col-span-4">
          ...
          <p className="text-muted-foreground max-w-xl text-lg leading-relaxed [text-wrap:_balance]">
            Collaboration and creativity drive everything we do. Our team
            members bring unique perspectives and expertise to every project.
          </p>
        </div>
        <div className="col-span-8 grid grid-cols-1 items-start gap-6 sm:grid-cols-2">
            ...
            >
              <CardHeader className="m-0 p-0">
                <div className="relative">
                  <Avatar className="m-0 h-24 w-24 shrink-0 transition-transform duration-300 group-hover:scale-110">
              ...
              <CardContent className="col-span-8 p-0">
