    ...
    <Card className="overflow-hidden shadow-sm transition-all hover:shadow-lg">
      <CardContent className="relative p-6">
        <div className="bg-background/80 absolute z-10 rounded-lg px-3 py-2 shadow-sm backdrop-blur-sm">
          <p className="text-2xl font-bold">$127,092.22</p>
        </div>
      ...
      <CardFooter className="bg-muted/20 flex flex-col items-start justify-between gap-4 border-t px-6 py-5 sm:flex-row sm:gap-6">
