    ...
    <>
      {showFirst && (
        <div className="relative w-full rounded-none border-0 bg-transparent">
          <div className="container mx-auto flex w-full flex-col items-center justify-between gap-6 gap-x-4 px-4 py-3 pt-1 leading-normal font-semibold text-black sm:pt-0 md:flex-row">
            <div className="flex flex-1 items-center gap-3">
              ...
              />
              <span>
                Welcome Aboard! We&apos;re thrilled to have you here. Discover
                our platform&apos;s features and start your journey today.
              </span>
            </div>
      ...
      {showSecond && (
        <div className="bg-primary text-primary-foreground relative mt-2 w-full rounded-none">
          <div className="container mx-auto flex w-full flex-col items-center justify-between gap-6 gap-x-4 px-4 py-3 pt-1 leading-normal font-semibold sm:pt-0 md:flex-row">
            <div className="flex flex-1 items-center gap-3">
              <img
                src="https://v3.material-tailwind.com/logo/spotify.svg"
                alt="spotify"
