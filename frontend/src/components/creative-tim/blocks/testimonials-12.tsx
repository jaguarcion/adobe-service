      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <Card className="grid bg-white">
            ...
            <CardFooter className="flex flex-col items-center justify-between gap-4 px-6 text-center md:flex-row md:text-start">
              <div>
          ...
          <Card className="grid bg-white">
            ...
            <CardFooter className="mt-auto flex flex-col items-center justify-between gap-4 px-6 text-center md:flex-row md:text-start">
              <div>
          ...
          <Card className="col-span-full grid bg-white">
            ...
            <CardFooter className="mt-auto flex flex-col items-center justify-center gap-4 px-6 text-center">
              <div>
